...
# tap11: rhel7-ost-pike2 (temp)
# tap12: rhel7-ost-pike3 (temp)
...
ifconfig tap11 create  # (temp)
ifconfig tap12 create  # (temp)
...
ifconfig bridge1 addm tap11 # (temp)
ifconfig bridge1 addm tap12 # (temp)
